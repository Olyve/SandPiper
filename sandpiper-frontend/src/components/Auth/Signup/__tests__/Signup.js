  ...
  describe('Submit Button', () => {
    ...
    describe('when clicked', () => {
      it('should call handleSignup', () => {
        ...
        expect(handleSignup.calledOnce).toEqual(true);
      });

      it('should pass state to handleSignup', () => {
        button.simulate('click', { preventDefault: () => {} });
        expect(handleSignup.calledWith({email: '', password: ''})).toEqual(true);
      });
    });
  });
  ...
  describe('Form Inputs', () => {
    ...
    describe('When the state changes', () => {
      it('should update the input value', () => {
        ...
        expect(email.instance().value).toEqual('mail@mail.com');
        expect(password.instance().value).toEqual('password1');
      });
    });
  });
});
